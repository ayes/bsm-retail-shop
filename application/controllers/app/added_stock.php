 ...
 */
class Added_stock extends CI_Controller {
    function __construct() {
        parent::__construct();
        $this->user_logged_in();
        $this->load->model('app/added_stock_model');
    }
    ...
    function index() {
        $data['content'] = 'app/object/stock/added_stock_view';
        $data['get_added_stock'] = $this->added_stock_model->get_added_stock();
        $this->load->view('app/template_view', $data);
    }
    
    function save() {
           
            $this->added_stock_model->save();
            $this->session->set_flashdata('message', 'Stock has been added..');
            redirect('app/added_stock');
    ...
    function search() {
        $data['content'] = 'app/object/stock/added_stock_view';
        $data['get_added_stock'] = $this->added_stock_model->get_search_stock();
        $this->load->view('app/template_view', $data);
    }
}
