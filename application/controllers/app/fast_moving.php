 ...
 */
class Fast_moving extends CI_Controller {
    function __construct() {
        parent::__construct();
        $this->user_logged_in();
        $this->load->model('app/fast_moving_model');
    }
    ...
    function index() {
        $data['content'] = 'app/object/statistic/fast_moving_view';
        $data['get_fast_moving'] = $this->fast_moving_model->get_fast_moving();
