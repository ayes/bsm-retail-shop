...
class Product_category extends CI_Controller {
    function __construct() {
        parent::__construct();
        $this->load->model('app/product_category_model');
    }
    function index() {
        $data['content'] = 'app/object/product_category/product_category_view';
        $data['getProductCategory'] = $this->product_category_model->getProductCategory();
        $this->load->view('app/template_view', $data);
    }
     function add() {
        $data['content'] = 'app/object/product_category/product_category_add';
         $this->load->view('app/template_view', $data);
    }
    function save() {
        $config = array(
