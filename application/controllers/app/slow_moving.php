 ...
 */
class Slow_moving extends CI_Controller {
    function __construct() {
        parent::__construct();
        $this->user_logged_in();
        $this->load->model('app/slow_moving_model');
    }
    ...
    function index() {
        $data['content'] = 'app/object/statistic/slow_moving_view';
        $data['get_slow_moving'] = $this->slow_moving_model->get_slow_moving();
