...
<h1>Dana Pinjaman</h1>
 <ol class="breadcrumb">
              ...
              <li class="active"><span class="glyphicon glyphicon-edit"></span> Dana Pinjaman</li>
            </ol>


          </div>
    <div class="col-lg-12">
<?php echo form_open('app/loan/save', array('role' => 'form')); ?>  
...
<?php foreach($get_cash_loan->result() as $row) : ?>                               
