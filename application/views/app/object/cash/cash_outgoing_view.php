...
<h1>Cash outgoing</h1>
 <ol class="breadcrumb">
              ...
              <li class="active"><span class="glyphicon glyphicon-edit"></span> Cash outgoing</li>
            </ol>


          </div>
    <div class="col-lg-12">
<?php echo form_open('app/cash_outgoing/save', array('role' => 'form')); ?>  
...
<?php foreach($get_cash_outgoing->result() as $row) : ?>                               
