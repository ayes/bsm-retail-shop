...
<h1>Detail Piutang Penjualan</h1>
 <ol class="breadcrumb">
              ...
              <li class="active"><span class="glyphicon glyphicon-edit"></span> Detail Piutang Penjualan</li>
            </ol>
...
<?php echo form_open('app/receivables_sales/payment', array('role' => 'form')); ?>  
...
<?php $no = $this->uri->segment(3); ?>
<?php foreach($get_pembayaran_piutang_penjualan->result() as $row) : ?>                               
<td><?php echo date("d-m-Y",strtotime($row->date)); ?></td>
