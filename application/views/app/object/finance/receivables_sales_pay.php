...
<h1>Receivables Sales <small>Pay</small></h1>
 <ol class="breadcrumb">
              <li><a href="/app/dashboard"><span class="glyphicon glyphicon-dashboard"></span> Dashboard</a></li>
              <li class="active"><span class="glyphicon glyphicon-edit"></span> Receivables Sales Pay</li>
            </ol>
...
<div class="row">
          <div class="col-lg-6">
<?php echo form_open('app/receivables_sales/save', array('role' => 'form')); ?>    
