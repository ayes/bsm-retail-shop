...
<h1>Return Selling Detail</h1>
 <ol class="breadcrumb">
              <li><a href="/app/dashboard"><span class="glyphicon glyphicon-dashboard"></span> Dashboard</a></li>
              <li class="active"><span class="glyphicon glyphicon-edit"></span> Return Selling Detail</li>
            </ol>
...
<div class="row">
    <div class="text-right col-lg-12">
         <?php echo anchor('app/return_selling/save_return/'.$nofak, 'RETURN SELLING'); ?>
    </div>
</div>
<br />
<div class="row">
