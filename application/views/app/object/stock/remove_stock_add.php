...
<h1>Stock<small> Add</small></h1>
 <ol class="breadcrumb">
              <li><a href="/app/dashboard"><span class="glyphicon glyphicon-dashboard"></span> Dashboard</a></li>
              <li class="active"><span class="glyphicon glyphicon-edit"></span> Stock Add</li>
            </ol>
...
<div class="row">
          <div class="col-lg-6">
<?php echo form_open('app/remove_stock/save', array('role' => 'form')); ?>    
 ...
 <div class="form-group">
    ...
    <input name="cost" value="0" type="text" class="form-control" id="cost" required="required">
      </div>
              <div class="form-group">
